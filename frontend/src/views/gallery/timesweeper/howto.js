...
export function render(){
  ...
  // Subheader with title link and tabs (Demo/Source)
  ...
  [
    'Primary click: reveal a cell (first click is always safe).',
    'Secondary click (right-click): toggle a flag on a cell you think is a mine.',
    'Double-click (or chord on a number): if the right number of adjacent flags are placed, reveal all remaining neighbors.',
  ...
  section.append(h, p1, p2, ul, p3, p4);
  frag.append(sub.root, section);
  return frag;
}
